...
export const AuthProvider = ({children}: any) => {
  ...
  let handleValidateEmail = (email: string) => {
    let re =
  ...
  const IsDoctorLoggedIn = async () => {
    setapploading(true);
    try {
      const access: any = await AsyncStorage.getItem('useraccesstoken');
      const refresh: any = await AsyncStorage.getItem('userrefreshtoken');
